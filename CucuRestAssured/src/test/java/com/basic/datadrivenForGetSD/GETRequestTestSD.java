...
public class GETRequestTestSD {
	...
	public void user_checks_data_at_path_having_value_in_jason(String jsnpath, String value) throws Throwable {
		...
		// if we have multiple element, get all element and validate that your
		// expected single element is present in list
		// List<Object> cirList =
		// res.body().jsonPath().getList("MRData.CircuitTable.Circuits.circuitId");
