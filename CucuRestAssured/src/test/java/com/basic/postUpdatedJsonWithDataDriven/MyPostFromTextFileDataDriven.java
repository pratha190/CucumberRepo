...
public class MyPostFromTextFileDataDriven {

	Response resp;

	@Given("^user hit the post request with \"([^\"]*)\" username and \"([^\"]*)\" job$")
	public void user_hit_the_post_request_with_username_and_job(String username, String job)
